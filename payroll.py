...
def payroll_export():
    ...
    # worksheet.write('G1', 'UNIFORM')
    # worksheet.write('H1', 'RICE')
    # worksheet.write('I1', 'LAUNDRY')
    # worksheet.write('J1', 'MEDICAL')
    # worksheet.write('K1', 'MEDICAL')
    ...
    for data in myresult:
        ...
        # # worksheet.write('G' + str(rowIndex),materialsxlx)
        # # worksheet.write('H' + str(rowIndex),rbdrxlx)
        # # worksheet.write('I' + str(rowIndex),tonxlx)
        # # worksheet.write('J' + str(rowIndex),price_mcxlx)
        # # worksheet.write('K' + str(rowIndex),amount_mcxlx)
     ...
     # this is for loan deduction and CS
        ...
        cursor.execute(
            ...
            (department, date1, empID, lastname,
             ...
             user_reg,
             date_time_update,on_off_saving))
        # 58
...
def net_pay():
    ...
    for data in fetch:
        ...
        elif salRate <= mwe_monthly and grossPay <= mwe_monthly and on_off_saving =='off':
            uniform = 0
            rice = 0
            laundry = 0
            medical1 = 0
...
# this function is for calculation of Taxable but gross is less than Deminimis!!!
        elif salRate > mwe_monthly and grossPay <= mwe_monthly and grossPay <= total_deminimis and basic_taxable <= 0 and on_off_saving =='on':
...
# this function is for computating  other Forms!!!!!!
        ...
        if afterDem >= 0 and salRate + float(allowance_search) >= mwe_monthly and on_off_saving =='on':
            ...
            elif salRate + float(allowance_search) > 15000 and salRate + float(allowance_search) >= mwe_monthly and on_off_saving =='on':
