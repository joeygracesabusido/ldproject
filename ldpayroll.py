    ...
    try:
        if id_searchTrans_entry.get()== "":
            ...
            for row in myresult:
                ...
                employeeID = row[2]
                regday_search = row[9]
                regdayOT_search = row[11]
                regSun_search = row[13]
                regSunOT_search = row[15]
                spl_search = row[17]
                splOT_search = row[19]
                legalDay_search = row[21]
                legalOT_search = row[23]
                shopRate_search = row[25]
                proviDay_search = row[27]
                proviDayOT_search = row[29]
                provisun_search = row[31]
                provisunOT_search = row[33]
                nightshif_search = row[35]
                adjustment_search = row[37]
                sss_search = row[40]
                phic_search = row[41]
                hdmf_search = row[42]
...
#"""This button is for Salary Computation with function def!!!!"""
    ...
    btn_update_payroll = Button(payroll_frame, text="Update Payroll", bg='white', fg='red', font=('arial', 9), width=15,
                          command=update_salary_comp)
    btn_update_payroll.place(x=990, y=120)
